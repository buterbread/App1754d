    ...
    <svg style="width: 0; height: 0">
      <defs>
        ...
        <path id="item__charge-delimiters-3"
          d="M17,36
          V18.577L1.046,9.366,0,10
          V36H17Zm2,0
          V18.577L34.955,9.366,36,10
          V36H19ZM33.955,7.634L18,16.845,2.046,7.634,0,6
          V0H36V6Z"/>
        <path id="item__charge-delimiters-4"
          d="M-8.87,18
          L3.86,5.27,16.591,18,3.86,30.73ZM5.272,3.858
          L18-8.872l12.73,12.73
          L18,16.588Zm0,28.284L18,19.412l12.73,12.73
          L18,44.873ZM19.414,18L32.145,5.27,44.875,18,32.145,30.73Z"/>
        <path id="item__charge-delimiters-5"
          d="M30.565,2.407
          L19.618,17.474,37.33,23.229,38,22
          V2H32Zm6.147,22.724
          L19,19.376V38H38
          V26ZM17,38V19.376
          L-0.712,25.131-2,26
          V38H17ZM5.435,2.407
          L16.382,17.474-1.33,23.229-2,22V2H4ZM28.947,1.232L18,16.3,7.053,1.232,7,0H29Z"/>
        <path id="item__charge-delimiters-6"
          d="M19.732,17
          L29.547,0H36V17H19.732Zm-3.464,0H0V0H6.453Zm0,2
          L6.453,36H0V19H16.268ZM27.238,0
          L18,16,8.762,0H27.238ZM8.762,36L18,20l9.238,16H8.762Zm10.97-17H36V36H29.547Z"/>
      </defs>
